        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td class='planTableActions'>
                        <a href='editPlan.php?ID=" . get_safe('ID') . "' class='button button-edit'><i class='fas fa-edit'></i>Edit</a>
                        <a href='?deleteID=" . get_safe('ID') . "' class='button button-delete' onclick='return confirm(\"Are you sure you want to delete this plan?\");'><i class='fas fa-trash-alt'></i>Delete</a>
                    </td>
                  </tr>";
        }
    } else {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6 mb-3">
                <form action="plans.php" method="get" class="form-inline">
                    <label for="searchBar" class="sr-only">Search Plans:</label>
                    <input type="text" id="searchBar" name="searchBar" class="form-control w-100 mb-2 mb-md-0" placeholder="Search Plans" required>
                </form>
            </div>
            <div class="col-12 col-md-6 mb-3">
                <form action="plans.php" method="post" class="form-inline">
